...
def main():
  ...
  if 'resnet' or 'vovnet' or 'densenet' in args.backbone:
    model = getattr(deeplab, args.backbone)(
  ...
  if args.train:
    ...
    elif 'vovnet' in args.backbone:
      backbone_params = (
          list(model.module.stem.parameters()) +
          list(model.module.stage2.parameters())+
          list(model.module.stage3.parameters())+
          list(model.module.stage4.parameters())+
          list(model.module.stage5.parameters()))
    elif 'densenet' in args.backbone:
      backbone_params = (
          list(model.module.features.parameters()))
